...
void main() {
  group('Theatre Flutter tests', () {
    testWidgets('App boots and shows bottom nav', (tester) async {
      ...
      for (final label in ['Home', 'Search', 'Downloads', 'Library']) {
        expect(
    ...
    test('ContentRef equality', () {
      const a = ContentRef(source: 'moviebox', contentId: 'abc', kind: ContentKind.movie);
      const b = ContentRef(source: 'moviebox', contentId: 'abc', kind: ContentKind.movie);
      expect(a, equals(b));
    });
